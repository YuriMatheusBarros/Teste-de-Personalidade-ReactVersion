...
function Intro() {
  ...
  return (
    <div className="intro">
      ...
      <p className='explicacao'>O objetivo é avaliar como você se comporta e se sente em diferentes situações. Composto por 33 perguntas — responda conforme sua própria percepção.</p>
