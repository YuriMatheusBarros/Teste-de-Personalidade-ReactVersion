...
function Intro() {
  ...
  return (
    <div className="intro">
      ...
      <p className='explicacao'>O objetivo é avaliar como você se comporta e se sente em diferentes situações. Composto por 30 perguntas — responda conforme sua própria percepção.</p>
      <p className='explicacao'><em>Este é apenas um teste de demonstração, baseado no modelo dos Cinco Fatores. Não substitui uma avaliação psicológica profissional.</em></p>
